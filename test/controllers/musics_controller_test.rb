...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { artist: @music.artist, genre: @music.genre, rating: @music.rating, review: @music.review, title: @music.title, year: @music.year } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { artist: @music.artist, genre: @music.genre, rating: @music.rating, review: @music.review, title: @music.title, year: @music.year } }
